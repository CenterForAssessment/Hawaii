...
Hawaii_Data_LONG_2014$GENDER <- as.factor(Hawaii_Data_LONG_2014$GENDER)
Hawaii_Data_LONG_2014$ELL_STATUS_MULTILEVEL <- as.factor(Hawaii_Data_LONG_2014$ELL_STATUS_MULTILEVEL)
Hawaii_Data_LONG_2014$SCHOOL_NAME <- as.factor(Hawaii_Data_LONG_2014$SCHOOL_NAME)
Hawaii_Data_LONG_2014$DISTRICT_NAME <- as.factor(Hawaii_Data_LONG_2014$DISTRICT_NAME)
