...
Hawaii_Data_LONG_2015_UPDATE <- read.csv("Data/Base_Files/Hawaii_Data_LONG_2015_UPDATE.txt", sep="|")
...
Hawaii_Data_LONG_2015_UPDATE$VALID_CASE <- toupper(as.character(Hawaii_Data_LONG_2015_UPDATE$VALID_CASE))
