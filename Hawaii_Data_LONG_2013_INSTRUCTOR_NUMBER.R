...
setnames(Hawaii_Data_LONG_2013_INSTRUCTOR_NUMBER, names(Hawaii_Data_LONG_2013_INSTRUCTOR_NUMBER), c("INSTRUCTOR_NUMBER", "INSTRUCTOR_LAST_NAME", "INSTRUCTOR_FIRST_NAME", "SCHOOL_NUMBER_INSTRUCTOR", "SCHOOL_NAME_INSTRUCTOR", "CONTENT_AREA",
...
Hawaii_Data_LONG_2013_INSTRUCTOR_NUMBER$GRADE <- NULL
...
setcolorder(Hawaii_Data_LONG_2013_INSTRUCTOR_NUMBER, tmp.column.order)
