...
Hawaii_Data_LONG_2017_2 <- fread("Data/Base_Files/Hawaii_Data_LONG_2017_Courtesy_Tested Prep.txt", colClasses=rep("character", 34))
...
Hawaii_Data_LONG_2017[Gr %in% c("1", "2", "9"), VALID_CASE:="INVALID_CASE"]
