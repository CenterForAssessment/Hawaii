...
setnames(Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER, 
	...
	c("INSTRUCTOR_NUMBER", "INSTRUCTOR_LAST_NAME", "INSTRUCTOR_FIRST_NAME", "SCHOOL_NUMBER", "SCHOOL_NAME", "CONTENT_AREA", "ROSTER_STATUS", "ID", "GRADE", "TERMS"))
...
Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER$SCHOOL_NUMBER <- Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER$SCHOOL_NAME <- Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER$GRADE <- NULL
Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER$TERMS <- Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER$ROSTER_STATUS <- NULL


### Set column order

tmp.column.order <- c('ID', 'CONTENT_AREA', 'YEAR', 'INSTRUCTOR_NUMBER', 'INSTRUCTOR_LAST_NAME', 'INSTRUCTOR_FIRST_NAME', 'INSTRUCTOR_WEIGHT', 'INSTRUCTOR_ENROLLMENT_STATUS')
