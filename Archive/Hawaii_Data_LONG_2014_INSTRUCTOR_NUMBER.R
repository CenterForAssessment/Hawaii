...
Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER <- as.data.table(read.delim("Data/Base_Files/BFK_Cleaned_Spring_2014.txt"))


### Remove duplicates

setkeyv(Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER, names(Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER))
...
variables.to.use <- c("StaffUniqueID", "StaffLastName", "StaffFirstName", "SchoolCode", "SchoolName", "SubjectName", "RosterStatus", "StateStudentID", "StudentGradeLevel", "Terms", "ClassName")
Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER <- Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER[,variables.to.use, with=FALSE]
...
setnames(Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER, 
	...
	c("INSTRUCTOR_NUMBER", "INSTRUCTOR_LAST_NAME", "INSTRUCTOR_FIRST_NAME", "SCHOOL_NUMBER_INSTRUCTOR", "SCHOOL_NAME_INSTRUCTOR", "CONTENT_AREA", "ROSTER_STATUS", "ID", "GRADE", "TERMS", "CLASS_NAME"))
Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER$YEAR <- "2014"
setcolorder(Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER, c(8,6,11,1,2,3,4,5,7,9,10,12))
...
setkey(Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER, ID, CONTENT_AREA, INSTRUCTOR_NUMBER, TERMS)
setkey(Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER, ID, CONTENT_AREA, INSTRUCTOR_NUMBER)
Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER <- Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER[setdiff(seq(dim(Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER)[1]), which(duplicated(Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER))-1)]
...
Hawaii_Data_LONG_2014_INSTRUCTOR_NUMBER$CLASS_NAME <- NULL
