...
Hawaii_Data_LONG_2018 <- fread("Data/Base_Files/Hawaii_Data_LONG_2018_Prep_all_v2.txt")
...
Hawaii_Data_LONG_2018[Gr %in% c("1", "2", "9", "12"), VALID_CASE:="INVALID_CASE"]
...
levels(Hawaii_Data_LONG_2018$Complex)[c(21,24)] <- paste(levels(Hawaii_Data_LONG_2018$Complex)[c(21,24)], "Complex")
